...
LABEL org.opencontainers.image.title="cdn"
LABEL org.opencontainers.image.description="A simple file server that can compress files on the fly"
LABEL org.opencontainers.image.source="https://github.com/Allypost/cdn-rs"
LABEL org.opencontainers.image.licenses="MPL-2.0"
LABEL org.opencontainers.image.authors="Josip Igrec <me@allypost.net>"
ARG RUST_TARGET
ARG BINARY_NAME
COPY --from=builder "/app/target/${RUST_TARGET}/release/${BINARY_NAME}" /cdn
EXPOSE 8000
ENTRYPOINT [ "/cdn" ]
